        ...
        <div className="page-container container">
            ...
            <section className="content-section">
                ...
                <div className="testimonial-grid">
                    <div className="testimonial-card">
                        <p className="testimonial-text">"The seedlings I purchased from Seedlings Webpage have transformed my garden. The quality is unmatched, and the support team is incredibly helpful."</p>
                        <p className="testimonial-author">- Jane Doe, Home Gardener</p>
                    </div>
                    <div className="testimonial-card">
                        <p className="testimonial-text">"As a small-scale farmer, finding reliable sources for quality seedlings is crucial. Seedlings Webpage has consistently provided top-notch plants that thrive in our local conditions."</p>
                        <p className="testimonial-author">- John Smith, Farmer</p>
                    </div>
                    <div className="testimonial-card">
                        <p className="testimonial-text">"I love the variety of seedlings available. It allows me to experiment with different crops and expand my garden. Highly recommended!"</p>
                        <p className="testimonial-author">- Sarah Johnson, Gardening Enthusiast</p>
                    </div>
                </div>
            </section>
            ...
            <section className="content-section text-content">
                ...
                <div className="contact-info">
                    <p><strong>Email:</strong> <a href="mailto:info@seedlingswebpage.com">info@seedlingswebpage.com</a></p>
